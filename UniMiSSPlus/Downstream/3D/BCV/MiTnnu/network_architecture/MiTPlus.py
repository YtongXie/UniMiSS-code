...
class MiTNET(SegmentationNetwork):
    ...
    def __init__(self, norm3D='BN3', act='ReLU', img_size3D=[48, 192, 192], num_classes=None, pretrain=False, pretrain_path=None):
        super().__init__()
        self.do_ds = False
        self.model = MiTnet(norm_cfg3D=norm3D, activation_cfg=act, img_size3D=img_size3D,
                            ...
                            num_heads=[4, 2, 1], depths=[1, 1, 1], mlp_ratios=[4, 4, 4], sr_ratios=[2, 4, 8], is_proj1=True)
