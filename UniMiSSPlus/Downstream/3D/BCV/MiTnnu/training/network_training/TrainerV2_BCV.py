...
from MiTnnu.network_architecture.MiTPlus import MiTNET
...
class TrainerV2_BCV(nnUNetTrainer):
    ...
    def initialize_network(self):
        ...
        self.network = MiTNET(norm3D=self.norm_cfg, act=self.activation_cfg, img_size3D=self.plans['plans_per_stage'][1]['patch_size'],
                                num_classes=self.num_classes, pretrain=self.pre_train, pretrain_path=pre_train_path).cuda()
    ...
    def do_split(self):
        ...
        if self.fold == "all":
            ...
            splits_file = join(self.dataset_directory, "splits_final_f1.pkl")
